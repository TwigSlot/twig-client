<template>
    ...
    <DataPanelVue @pauseKeyDown="pauseKeyDown" @resumeKeyDown="resumeKeyDown" :data_panel="dataPanel"></DataPanelVue>
    <ControlPanelVue @home="home" @customkeydown="keydown" ref="control_panel_ref"></ControlPanelVue>
</template>
<script lang="ts">
